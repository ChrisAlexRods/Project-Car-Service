          ...
          <div className="shadow p-4 mt-4">
            ...
            <form id="create-hat-form" onSubmit={handleSubmit} >
              <div className="form-floating mb-3">
                <input placeholder="sales_name" onChange={handleNameChange} required type="text" name="sales_name" id="sales_name" className="form-control" />
                <label htmlFor="sales_name">Sales person</label>
              </div>
              <div className="form-floating mb-3">
                <input placeholder="employee_number" onChange={handleEmployeeIdChange} required type="text" name="employee_number" id="employee_number" className="form-control" />
